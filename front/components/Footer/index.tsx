...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-[#0D133E] bg-opacity-5 pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright © 2023 <a href="https://www.linkedin.com/in/mohammad-asad-khan/" rel="nofollow noopener">iasadk</a>. All Rights Reserved.
            </p>
          </div>
        </div>
